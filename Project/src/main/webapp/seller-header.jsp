                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light mt-2">
                                <a href="seller-upload-product.jsp" class="dropdown-item">Upload</a>
                                <a href="seller-manage-product.jsp" class="dropdown-item">Manage</a>
                            </div>
                             </div>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Welcome,<%=s.getName()%></a>
                            <div class="dropdown-menu bg-light mt-2">
