...
<div class="container-fluid py-5">
        <div class="container py-5">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 500px;">
                <div class="btn btn-sm border rounded-pill text-primary px-3 mb-3">Seller Register</div>
            </div>
                    ...
                    <div class="wow fadeIn" data-wow-delay="0.3s">
                        <form action="seller" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <button class="btn btn-primary w-100 py-3" name = "action" value = "register" type="submit">Seller Register</button>
                                </div>
                            </div>
                        </form>
                    </div>
