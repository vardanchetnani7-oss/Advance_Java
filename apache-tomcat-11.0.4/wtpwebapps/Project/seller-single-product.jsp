	...
	<div class="container-fluid py-5">
		<div class="container py-5">
			<div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s"
				...
				<div class="btn btn-sm border rounded-pill text-primary px-3 mb-3">Product
					Update</div>
			</div>
								...
								<div class="col-md-6">
									<div class="form-floating">
										...
										<input type="text" class="form-control" name="pname"
											value="<%=p.getPname()%>" id="email" placeholder="Name">
								...
								<div class="col-6">
									<div class="form-floating">
										<input type="text" class="form-control" name="pprice"
											value="<%=p.getPprice()%>" id="email" placeholder="Password">
								...
								<div class="col-6">
									<div class="form-floating">
										<input type="text" class="form-control" name="pcategory"
											value="<%=p.getPcategory()%>" id="email"
											placeholder="Address"> <label for="email">ProductCategory</label>
									</div>
								</div>
